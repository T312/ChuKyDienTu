...
namespace ChuKyDienTu
{
    public partial class FrmKyVanBan : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void barBtnUploadImg_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
        ...
        private void BarBtnDinhDang_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            returnDocParts[0] = returnDocParts[0].TrimEnd();
            //returnDocParts[0] = richEditControlVanBan.Text.Remove(richEditControlVanBan.Text.IndexOf("\r\n"));
